...
def doctor_home(request):
    ...
    return render(request, 'doctor/doctor_home.html', {'doc_name': doc_name,'patients_count': patients_count, 'total_bookings' : total_bookings,'doctor': doctors })
...
def appointment(request):
    ...
    return render(request, 'doctor/appointment.html',{'booking_records' : records,'doctor':doctors})
...
def change_password(request):
    ...
    return render(request, 'doctor/change_paswd.html', {'error_msg': error_msg, 'success_msg': success_msg,'doctor':doctors})
